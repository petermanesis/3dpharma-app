...
Run `generate_passkey.py` from the project root directory.
...
First-use timestamps are stored in `passkey_store.json` in the project root. Do not delete this file or previously issued keys will reset their timers.
